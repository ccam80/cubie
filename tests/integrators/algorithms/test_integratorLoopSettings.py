...
class TestLoopStepConfig:
    ...
    @pytest.mark.parametrize(
        "dt_min, dt_max, dt_save, dt_summarise, atol, rtol",
        [
    ...
    def test_custom_initialization(
        self, dt_min, dt_max, dt_save, dt_summarise, atol, rtol
    ):
...
class TestIntegratorLoopSettings:
    ...
    def test_default_initialization(
        self, mock_buffer_sizes, mock_step_config, mock_functions
    ):
    ...
    def test_precision_validation(
        self, precision, mock_buffer_sizes, mock_step_config, mock_functions
    ):
    ...
    def test_invalid_precision_raises_error(
        self, mock_buffer_sizes, mock_step_config, mock_functions
    ):
    ...
    def test_step_config_properties(
        self, mock_buffer_sizes, mock_step_config, mock_functions
    ):
    ...
    def test_buffer_sizes_property(
        self, mock_buffer_sizes, mock_step_config, mock_functions
    ):
    ...
    def test_function_assignment(
        ...
        assert (
            settings.update_summaries_func
            == mock_functions["update_summaries_func"]
        )
        assert (
            settings.save_summaries_func
            == mock_functions["save_summaries_func"]
        )
    ...
    def test_none_functions_allowed(self, mock_buffer_sizes, mock_step_config):
        ...
        settings = IntegratorLoopSettings(
            loop_step_config=mock_step_config, buffer_sizes=mock_buffer_sizes
        )
