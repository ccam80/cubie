"""Test Rosenbrock dynamic controller defaults selection.
...
The test ensures that the default Rosenbrock tableau selects appropriate
controller defaults:
...
Notes
-----
This test uses the actual default Rosenbrock tableau and adapts assertions
based on its ``has_error_estimate`` property. This ensures the test remains
valid even if the default tableau changes in the future.
"""
