    ...
    try:
        ...
        for event_name in [
            ...
            assert len(start_events) == 1, (
                f"Expected 1 start event for {event_name}"
            )
            assert len(stop_events) == 1, (
                f"Expected 1 stop event for {event_name}"
            )
        ...
        for event_name in [
            ...
            assert duration >= 0, (
                f"Duration should be non-negative for {event_name}"
            )
