...
def jvp_factory(constants, precision):
    ...
    def jvp(state, parameters, drivers, v, jvp):
        j_01 = 0
        j_11 = 2 * state[1]
        _cse0 = parameters[2] * parameters[3]
        aux_1 = _cse0 * state[0] + parameters[7] * parameters[0]
        j_00 = _cse0
        j_10 = 2 * _cse0 + 1
        aux_2 = (
            aux_1
...
def dxdt_factory(constants, precision):
    ...
    def dxdt(state, parameters, drivers, observables, dxdt):
        observables[0] = (
            ...
            + parameters[2] * parameters[3] * state[0]
        )
        dxdt[0] = parameters[6] + observables[0]
        observables[1] = (
            parameters[6] * parameters[6] * parameters[5]
            + observables[0]
            + state[0]
        ...
        dxdt[1] = parameters[7] + observables[0] + observables[1]
