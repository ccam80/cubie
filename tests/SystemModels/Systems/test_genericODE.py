...
testsets=[
        ...
        ((np.float64, ["x1", "x2"], ["p1", "p2"], ["o1"], {'c1': 2.0}, 2),
         ...
         (np.asarray([1.0, 0.0], dtype=np.float64), np.asarray([0.5, 5.5], dtype=np.float64), np.asarray([4.2], dtype=np.float64)),
        ...
        ((np.float64, ["x1","x2","x3","x4","x5", "x6"], ["p1", "p2"], ["o1", "o2","o3","o4","o5","o6",], {'c1': 8.0}, 6),
         (np.asarray([1.0, 0.0, 3.0, 4.0, 2.0, 5.0], dtype=np.float64), np.asarray([0.5, 5.5], dtype=np.float64), np.asarray([4.2, 1.8, 4.6, 1.7, 4.1, 2.3], dtype=np.float64)),
