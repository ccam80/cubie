...
from cubie._utils import (
    clamp_64, clamp_32, get_noise_64, get_noise_32,
    slice_variable_dimension, in_attr, is_attrs_class,
    update_dicts_from_kwargs, timing, round_sf, round_list_sf,
    get_readonly_view
)
...
def test_slice_variable_dimension():
    ...
    # Test error cases
    with pytest.raises(ValueError, match="slices and indices must have the same length"):
