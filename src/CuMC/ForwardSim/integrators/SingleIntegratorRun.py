...
from CuMC.ForwardSim.integrators.IntegratorRunSettings import \
...
class SingleIntegratorRun:
    ...
    def output_array_heights(self):
        """Exposes :attr:`~CuMC.ForwardSim.OutputHandling.output_functions
    ...
    @property
    def precision(self):
        """Exposes :attr:`~CuMC.SystemModels.Systems.GenericODE.GenericODE
        .precision` from the child GenericODE object."""
        return self._system.precision

    @property
    def threads_per_loop(self):
        """Exposes :attr:`~CuMC.ForwardSim.integrators.algorithms
    ...
    @property
    def system(self):
        """Exposes child :attr:`~CuMC.SystemModels.Systems.GenericODE
        .GenericODE` object
        object."""
        return self._system
