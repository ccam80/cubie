...
class SingleIntegratorRunCore(CUDAFactory):
    ...
    def __init__(
        ...
        self._loop = self.instantiate_loop(
                ...
                controller_shared_elements=self._step_controller.shared_memory_elements,
    ...
    def instantiate_loop(
        ...
        controller_shared_elements: int,
        ...
        controller_shared_elements
            Persistent shared memory elements required by the controller.
        algorithm_local_elements
            Persistent local memory elements required by the algorithm.
        algorithm_shared_elements
            Shared memory elements required by the step algorithm
        compile_flags
